 ...
 * Requires: admin role
 */
router.post('/:id/approve-estimate', verifyAuth, authorize('admin'), (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 * Requires: admin role
 */
router.post('/:id/reject-estimate', verifyAuth, authorize('admin'), (req: Request, res: Response) => {
  try {
    const { id } = req.params;

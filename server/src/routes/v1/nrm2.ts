 ...
 */
router.get('/groups/:id', (req: Request, res: Response): void => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/elements/:id', (req: Request, res: Response): void => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/sub-elements/:id', (req: Request, res: Response): void => {
  try {
    const { id } = req.params;
...
router.get('/tree', (req: Request, res: Response): void => {
  try {
    ...
    const id = groupId ? parseInt(groupId as string) : undefined;

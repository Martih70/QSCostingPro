...
import boqRepositoryRoutes from './routes/v1/boqRepository.js';
import boqLibraryBrowserRoutes from './routes/v1/boqLibraryBrowser.js';
...
app.use('/api/v1/boq-repository', boqRepositoryRoutes);
app.use('/api/v1/boq-library', boqLibraryBrowserRoutes);

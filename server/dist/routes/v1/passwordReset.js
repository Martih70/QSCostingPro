...
import { requestPasswordReset, resetPassword, verifyResetToken, } from '../../services/passwordResetService.js';
 ...
 */
router.post('/request', validate(requestResetSchema), (req, res) => {
    try {
 ...
 */
router.post('/verify', validate(verifyTokenSchema), (req, res) => {
    try {
